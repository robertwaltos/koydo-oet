...
const EXAM_ID = "oet";
const EXAM_DISPLAY_NAME = "OET (Occupational English Test)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Listening, Reading, Writing, and Speaking in healthcare professional contexts. Use medical scenario examples.
