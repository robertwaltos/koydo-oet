...
export const metadata: Metadata = {
  title: "Pricing — Oet Premium",
  description: "Unlock unlimited Oet practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=oet&cadence=annual`;
